            ...
            <div className="con-right">
                <form action="#">
                    ...
                    <div className="file-upload">
                        ...
                        <button className="file-upload__button"><img src="./attach_file.png"/></button><span className="file-upload__label">ATTACH A FILE(DOC, PDF, ZIP)</span>
                        <span className="file-upload__label">No file(s) selected</span>
                    </div>
