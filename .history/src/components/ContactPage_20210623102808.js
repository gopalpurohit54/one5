...
function ContactPage() {
    ...
    const upload__button = document.getElementById("upload-button");
    const upload__label = document.getElementById("upload-label");

    upload__button.addEventListener("click", function() {
        myFile.click();
    });
            ...
            <div className="con-right">
                <form action="#">
                    ...
                    <div className="file-upload">
                        ...
                        <button className="file-upload__button" id="upload-button"><img src="./attach_file.png"/></button>
                        <span className="file-upload__label" id="upload-label">ATTACH A FILE(DOC, PDF, ZIP)</span>
                    </div>
