        ...
        <div className="project-wrapper">
            <div className="project-1">
                ...
                <div className="p1-img">
                    <img src= "./sns.png" alt= "Loading..." href="https://snsbabycare.com.au/" />
                </div>
            </div>
            <div className="project-2">
                <div className="p2-img">
                    <img src= "./ausport.png" alt= "Loading..."  href="https://ausport-new.myshopify.com/"/>
                </div>
            ...
            <div className="project-3">
                ...
                <div className="p3-img">
                    <img src= "./tiffany.png" alt= "Loading..." href="https://misstiffanyshen.com/" />
                </div>
            </div>
            <div className="project-4">
                <div className="p4-img">
                    <img src= "./essentially-brands.png" alt= "Loading..." href="https://essentiallybrands.com/" />
                </div>
            ...
            <div className="project-5">
                ...
                <div className="p5-img">
                    <img src= "./staged-homes.png" alt= "Loading..." href="https://stagedhomesbymelissa.com/" />
                </div>
            </div>
            <div className="project-6">
                <div className="p6-img">
                    <img src= "./accord-retail.png" alt= "Loading..." href="https://accordretail.com.au/" />
                </div>
