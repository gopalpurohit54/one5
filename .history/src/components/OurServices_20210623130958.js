    ...
    <div className="our-services">
        ...
        <div className="service-wrapper">
            <ul className="service-1">
                <h6>WEB DESIGN</h6>
                <p className="service-desc">Our goal is to build you an amazing online web presence. Through 
            ...
            <ul className="service-2">
                ...
                <p className="service-desc">We offer a complete suite of marketing services to fully support clientsfrom initial research 
            ...
            <ul className="service-3">
                <h6>LOGO DESIGN</h6>
                <p className="service-desc">We craft meaningful brands through visual identity, print and digital experience 
            ...
            <ul className="service-4">
                ...
                <p className="service-desc">We will help you to organise and manage all your sales, stock, accounting, shipping and 
